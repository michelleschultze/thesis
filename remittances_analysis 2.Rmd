...
```{r}
fulldata <- fulldata %>%
  dplyr::select(Month, Ramadan_starts, Eid_al_Fitr, Eid_al_Adha, war, post_war, crocus, post_crocus, covid, jan, feb, mar, apr, may, jun, jul, aug, sep, oct, nov, dec, time_trend, log_Remittances_fromRus, log_mediazona, `log_Consumer_Price_Index_(CPI)_KGZ`, `log_Consumer_Price_Index_(CPI)_RUS`)
```
